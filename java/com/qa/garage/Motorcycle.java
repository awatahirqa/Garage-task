...
public class Motorcycle extends Vehicle{
	...
	public Motorcycle(String colour, String enginesize, String transmission, String fuel, int power, int nofwheels,
			int topspeed) {
	...
	public String toString() {
		return "Motorcycle [nofwheels=" + nofwheels + ", topspeed=" + topspeed + ", transmission=" + transmission
				+ ", colour=" + colour + ", enginesize=" + enginesize + ", fuel=" + fuel + ", power=" + power + "]";
	}
